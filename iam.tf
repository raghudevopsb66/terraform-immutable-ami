resource "aws_iam_policy" "parameter-store-access" {
  name        = "RoboShop_${var.COMPONENT}_ami_ParameterStore_Access"
  path        = "/"
  description = "RoboShop_${var.COMPONENT}_ami_ParameterStore_Access"
...
resource "aws_iam_role" "parameter-store-access" {
  ...
  tags = {
    tag-key = "RoboShop_${var.COMPONENT}_ami_ParameterStore_Access"
  }
}
